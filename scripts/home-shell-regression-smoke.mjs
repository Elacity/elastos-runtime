...
assert(
  homeGuiTemplate.includes('id="setup-sheet"') &&
    homeGuiTemplate.includes('id="setup-sheet-later"') &&
    homeGuiTemplate.includes('id="setup-sheet-recovery"') &&
    !homeGuiTemplate.includes('id="setup-sheet-profile"'),
  "Home setup offers Recovery Kit and Later through the existing sheet",
);
assert(
...
assert(
  homeSetupSheetScript.includes(': profileReady ? "Save Recovery Kit" : "Continue recovery";') &&
    homeSetupSheetScript.includes('recoveryButton.disabled = recoveryActBusy || complete || !targetById(') &&
