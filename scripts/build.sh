...
show_help() {
    ...
    echo "  App capsules:     capsules/         (chat, did-provider, chain-provider, wallet-provider, drm-provider, rights-provider, key-provider, decrypt-provider, availability-provider, ai-provider, llama-provider, agent, ipfs-provider, site-provider, tunnel-provider)"
...
APP_CAPSULES=(
    ...
    "drm-provider:capsules/drm-provider"
    "rights-provider:capsules/rights-provider"
    "key-provider:capsules/key-provider"
...
if [ "$BUILD_ALL" = false ]; then
    echo -e "${DIM}Run with --all to also build chat, did-provider, chain-provider, wallet-provider, drm-provider, rights-provider, key-provider, decrypt-provider, availability-provider, ai-provider, llama-provider, agent, ipfs-provider.${NC}"
fi
echo ""
