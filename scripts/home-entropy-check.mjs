...
assert(
  system.includes('id="recovery-password"') &&
    ...
    system.includes("Keep your files backed up separately.") &&
    !system.includes('id="recovery-profile-name"') &&
    !systemJs.includes("intent.profile_display_name") &&
    systemJs.includes('recoveryProfileStatus !== "ready"') &&
    systemJs.includes("Import your Recovery Kit to restore your Profile before saving a new kit.") &&
