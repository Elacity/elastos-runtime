...
"$node_bin" -e '
  ...
  proof.profile_reset.receipt.profile.disk_path = "/tmp/elastos-fixture/Users/0123456789ab/BrowserProfiles/default/profile.ext4";
  fs.writeFileSync(process.argv[2], `${JSON.stringify(proof, null, 2)}\n`);
...
const sourceHomeRestart = {
  ...
  dry_run: false,
  generated_at: "2026-06-19T00:00:00.000Z",
  repo: "/tmp/elastos-source-home-fixture/repo",
  test_home: "/tmp/elastos-source-home-fixture/test-home",
  data_dir: "/tmp/elastos-source-home-fixture/test-home/Library/Application Support/elastos",
  addr: "localhost:61180",
  home_url: "http://localhost:61180/apps/home/",
  gateway_bin: "/tmp/elastos-source-home-fixture/repo/elastos/target/release/elastos",
  gateway_log: "/tmp/elastos-source-home-fixture/test-home/logs/gateway-smoke.log",
  http_code: 200,
