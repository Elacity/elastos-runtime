...
LADDER=(
  ...
  "dkms-authority (default)|dkms-authority||21"
  ...
  "decrypt-provider rail-shim-mldsa|decrypt-provider|rail-shim-mldsa|57"
  "decrypt-provider harden|decrypt-provider|harden|68"
  "decrypt-provider rail-live|decrypt-provider|rail-live|60"
  ...
  "decrypt-provider rail-stream|decrypt-provider|rail-stream|79"
)
