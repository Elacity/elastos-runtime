...
LADDER=(
  ...
  "ddrm-envelope (lib)|ddrm-envelope||35"
  ...
  "dkms-authority (default)|dkms-authority||19"
  ...
  "decrypt-provider rail-shim-mldsa|decrypt-provider|rail-shim-mldsa|55"
  "decrypt-provider harden|decrypt-provider|harden|66"
  "decrypt-provider rail-live|decrypt-provider|rail-live|58"
  "decrypt-provider rail-bind|decrypt-provider|rail-bind|61"
  "decrypt-provider rail-mint|decrypt-provider|rail-mint|63"
  "decrypt-provider rail-audit|decrypt-provider|rail-audit|63"
  "decrypt-provider rail-material|decrypt-provider|rail-material|73"
)
