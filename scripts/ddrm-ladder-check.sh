...
LADDER=(
  ...
  "ddrm-envelope (lib)|ddrm-envelope||36"
  ...
  "dkms-authority (default)|dkms-authority||20"
  ...
  "decrypt-provider rail-shim-mldsa|decrypt-provider|rail-shim-mldsa|56"
  "decrypt-provider harden|decrypt-provider|harden|67"
  "decrypt-provider rail-live|decrypt-provider|rail-live|59"
  "decrypt-provider rail-bind|decrypt-provider|rail-bind|62"
  "decrypt-provider rail-mint|decrypt-provider|rail-mint|64"
  "decrypt-provider rail-audit|decrypt-provider|rail-audit|64"
  "decrypt-provider rail-material|decrypt-provider|rail-material|74"
)
