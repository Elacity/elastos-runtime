...
LADDER=(
  ...
  "ddrm-envelope (lib)|ddrm-envelope||27"
  "ddrm-plan-runner (lib)|ddrm-plan-runner||45"
  "key-provider (default)|key-provider||18"
  "key-provider key-authority-ref|key-provider|key-authority-ref|44"
  "dkms-authority (default)|dkms-authority||15"
  ...
  "decrypt-provider rail-material|decrypt-provider|rail-material|70"
)
