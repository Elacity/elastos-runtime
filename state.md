...
| --- | --- | --- | --- |
| Local source candidate | `feat/0.7.1-model-assistant-closeout` code baseline `7f4e27de` (tree `8c84e039`); Smol readiness code `a1573675`; CID-scoped receipt repair and three regression tests `e06950d5`. | The current branch contains the repaired Content lookup and its focused tests. The installed Owner reply remains bound to the older `a1573675` artifact; the public Runtime is a separate one-function projection of the repair. | No one installed candidate represents all three Homes. Matching-build two-Home proof and integrated public release remain open. |
