...
a fresh read-only artifact and resource preflight. The receipt repair can be
built and tested without a CPU-plan decision once the disk reserve is restored.
One later short seed-local Assistant run needs a verified
