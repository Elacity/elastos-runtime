...
### Added
- Added a provider-backed Library / Explorer release slice: PC2-familiar
  ...
  takeover, and PC2-style context menus now run through Runtime-scoped Library
  provider authority.
...
- Added the current Spaces/WebSpace contract for Library:
  ...
  **Spaces**, provider targets such as `google://drive/...` remain
