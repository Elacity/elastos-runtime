...
//! `initramfs`. The key constraints are:
//!
...
//!
//! The builder wires `setInitialRamdiskURL:` for distro kernels that
...
mod tests {
    ...
    fn build_boot_loader_with_none_initramfs_leaves_ramdisk_unset() {
        // Guard against accidentally setting an empty
