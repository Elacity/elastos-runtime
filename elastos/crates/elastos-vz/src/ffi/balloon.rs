...
//!
//! Vz exposes the standard virtio memory balloon device for
//! cooperative memory reclaim. The supervisor's memory accounting
//! drives it from the host side; the configuration here only ensures
//! the guest sees the device.
//!
