...
//!
//! Phase 0 §D pitfall #1 (`docs/vz-backend/PHASE_0_SCOPE.md`) +
//! UTM issue #4840: Vz attaches raw disk images via
...
//!
//! Day 1 reality probe verified both enum values exist in
//! `objc2-virtualization 0.3` and the attachment constructs
