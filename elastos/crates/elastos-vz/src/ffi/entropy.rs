...
//!
//! Phase 0 §B row "entropy": Vz exposes the host's CSPRNG to the
//! guest through a virtio-rng device. No knobs to configure;
//! attaching the device is enough.
//!
...
//!
//! Day 1 reality probe verified the construction.
