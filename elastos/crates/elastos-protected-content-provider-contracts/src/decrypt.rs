        ...
        match self.0 {
            ...
            DecryptProviderRequestKindV1::OpenViewerSession {
                ...
                let expected_terminal_issuer =
                    TerminalReceiptIssuerKey::new(expected_terminal_issuer)?;
                let custody_envelope = custody_envelope.decode()?;
    ...
    pub fn recipient_public_key(&self) -> Result<RecipientPublicKeyBytesV1, ContractError> {
        match &self.0 {
            DecryptProviderResponseKindV1::PreparedRecipient {
                ...
                ..
            } => RecipientPublicKeyBytesV1::new(*recipient_public_key),
...
mod tests {
    use crate::{
        test_support::{
            custody_envelope, custody_envelope_for_seed, make_signed_node_contribution,
    ...
    use elastos_protected_content_contracts::RuntimeReleaseAuditIdV1;
