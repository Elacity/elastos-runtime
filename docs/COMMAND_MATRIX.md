...
| `elastos run`, other manifest types or no manifest | Self-contained | Falls through to the local runner. This is outside the supported capsule-authoring contract. A non-Component WASM manifest is rejected. |
