...
The detailed design and authority checklist lives in
[FILE_MANAGER_MIGRATION.md](FILE_MANAGER_MIGRATION.md). Treat that file as the
gate before implementing the first Explorer slice.
