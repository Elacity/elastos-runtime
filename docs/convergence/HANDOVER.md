...
- ⬜ **Missing middle:** a **key authority** (ElastOS-native PQ-hybrid dKMS, or a
  ...
  dev orchestrator stands in for it); the **producer side** real `plaintext_ref`→IPFS; a
  **viewer**.
