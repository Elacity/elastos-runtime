...
This dated snapshot preserves the former Later, Next and Long term sections of `TASKS.md` at commit `f0fae26f`. Its ports, branches, owners and status claims are historical. It does not assign work or set release scope. Triage an item into the current queue only after checking the release plan, current State and target evidence.
...
- [ ] Implement the signed content-capsule catalog and typed Get contract in
  [docs/CONTENT_CAPSULE_DISTRIBUTION.md](../CONTENT_CAPSULE_DISTRIBUTION.md).
...
- [ ] Prove the WSL-first strategy in [docs/WINDOWS.md](../WINDOWS.md) on a
...
- [ ] Implement encrypted mailbox delivery per the boundary recorded under
  "Later work" in
  [docs/COLLABORATION_HANDOFF.md](../COLLABORATION_HANDOFF.md), after
...
- [ ] Use the capsule contract in
  [docs/CAPSULE_MODEL.md](../CAPSULE_MODEL.md) as the shared
