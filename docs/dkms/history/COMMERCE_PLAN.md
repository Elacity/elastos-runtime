...
- **P1 — bind buy terms to the re-verified on-chain listing + abort-on-drift.** DO FIRST; gates everything. No buy ships before this. → [the buy invariant](../COMMERCE.md)
