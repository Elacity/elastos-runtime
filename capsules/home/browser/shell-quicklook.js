...
const titleNode = document.querySelector("#quick-look-title");
const metaNode = document.querySelector("#quick-look-meta");
const openButton = document.querySelector("#quick-look-open");
const closeButton = document.querySelector("#quick-look-close");
