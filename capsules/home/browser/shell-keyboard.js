...
import { toggleSpotlight } from "./shell-spotlight.js?v=home-20260717a";
import {
  focusWindow,
  closeWindow,
...
import {
  ...
  isExposeOpen,
  toggleExpose,
} from "./shell-expose.js?v=home-20260717a";
import {
  hideQuickLook,
  isQuickLookOpen,
  toggleQuickLook,
...
const switcherRoot = document.querySelector("#window-switcher");
const switcherList = document.querySelector("#window-switcher-list");
...
/* ---- Desktop arrow-key navigation (wired from shell.js) ---- */
