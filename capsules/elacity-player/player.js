...
// Release the media session (and the authority subprocess it pins) the moment this
// player goes away, instead of waiting for the server-side TTL. keepalive lets the
