...
import {
  ...
  syncIdentity,
  updateClock,
} from "./shell-chrome.js?v=home-20260804az";
import {
  beginDesktopMarquee,
  bindShellSurfaceDom,
  ...
  updateTaskbarState,
} from "./shell-surface.js?v=home-20260804az";
import { bindAgentShelf } from "./agent-shelf.js?v=home-20260804az";
import { bindAgentHarness } from "./agent-harness.js?v=home-20260804az";
import {
...
} from "./shell-windows.js?v=home-20260804az";
import {
  bindShellKeyboard,
  handleDesktopArrowKey,
  retireKeyboardSurfaces,
  toggleShortcutsOverlay,
} from "./shell-keyboard.js?v=home-20260804az";
import {
  bindSpotlight,
  hideSpotlight,
  showSpotlight,
} from "./shell-spotlight.js?v=home-20260804az";
import {
  bindNotificationCenter,
  hideNotificationCenter,
  recordNotifications,
} from "./shell-notifications.js?v=home-20260804az";
import {
  bindMenubar,
  closeMenus,
  setMenuManifest,
  syncMenubar,
} from "./shell-menubar.js?v=home-20260804az";
import {
  bindQuickLook,
  hideQuickLook,
  toggleQuickLook,
} from "./shell-quicklook.js?v=home-20260804az";
import { bindExpose, closeExpose, toggleExpose } from "./shell-expose.js?v=home-20260804az";
import {
  bindMobilePlaneSwipe,
  bindSpaceEdgePeek,
  bindSpacePager,
  toggleActiveFullscreenStage,
} from "./shell-stages.js?v=home-20260804az";
import { setUiSoundsEnabled } from "./shell-sounds.js?v=home-20260804az";
import { setFocusModeEnabled } from "./shell-core.js?v=home-20260725a";
import {
  bindControlCentre,
  hideControlCentre,
  syncControlCentre,
} from "./shell-control-centre.js?v=home-20260804az";
import {
  bindWalletRail,
  retireWalletRail,
  showWalletRail,
...
} from "./shell-wallet-rail.js?v=home-20260804az";
import {
  bindInboxRail,
  retireInboxRail,
  toggleInboxRail,
...
} from "./shell-inbox-rail.js?v=home-20260804az";
import {
  bindConnectorSheet,
  connectorSheetFrame,
  ...
  showConnectorSheet,
} from "./shell-connector-sheet.js?v=home-20260804az";
