...
const HOME_GUI_TEMPLATE_URL = new URL("./home-gui-template.html?v=home-20260812a", import.meta.url).href;
const HOME_GUI_STYLESHEET_ID = "home-gui-stylesheet";
const HOME_GUI_STYLESHEET_URL = new URL("./style.css?v=home-20260812a", import.meta.url).href;
