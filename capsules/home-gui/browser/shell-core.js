...
const HOME_GUI_TEMPLATE_URL = new URL("./home-gui-template.html?v=home-20260724cj", import.meta.url).href;
const HOME_GUI_UI_STYLESHEET_ID = "home-gui-elastos-ui";
const HOME_GUI_UI_STYLESHEET_URL = new URL("./elastos-ui.css?v=home-20260724cj", import.meta.url).href;
const HOME_GUI_STYLESHEET_ID = "home-gui-stylesheet";
const HOME_GUI_STYLESHEET_URL = new URL("./style.css?v=home-20260724cj", import.meta.url).href;
...
const APP_ICON_ASSET_VERSION = "home-20260724cj";
