import { TIP as APP_ICON_ASSET_VERSION } from "./agent-tip.js?v=home-20260804av";
...
const HOME_GUI_TEMPLATE_URL = new URL("./home-gui-template.html?v=home-20260804av", import.meta.url).href;
const HOME_GUI_UI_STYLESHEET_ID = "home-gui-elastos-ui";
const HOME_GUI_UI_STYLESHEET_URL = new URL("./elastos-ui.css?v=home-20260804av", import.meta.url).href;
...
const HOME_GUI_AGENT_STYLESHEET_URL = new URL(
  "./agent-harness.css?v=home-20260804av",
  import.meta.url,
).href;
