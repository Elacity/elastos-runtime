 ...
 * Web Audio oscillators; no network, no asset fetch. Triggered from shell
 * toast / trash empty / refusal paths. The Home host owns persistence and
 * replays the choice into this session.
 */
