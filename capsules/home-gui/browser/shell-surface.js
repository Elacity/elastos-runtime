...
import { inboxRailAvailable, showInboxRail } from "./shell-inbox-rail.js?v=home-20260814a";
import { closeExpose, isExposeOpen } from "./shell-expose.js?v=home-20260814a";
import { TIP as SHELF_TIP } from "./agent-tip.js?v=home-20260814a";
...
let desktopHintDismissedThisSession = false;
...
function dismissDesktopFirstRunHint() {
  ...
  desktopHintDismissedThisSession = true;
  hint.hidden = true;
...
/* ---- Dock auto-hide (host-persisted preference; see home:ui-preference) ----
   Keep the current value in memory; the Home host owns persistence and replays
   it at boot. */
