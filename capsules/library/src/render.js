...
export function createLibraryRenderer({
  ...
  function renderListHeader() {
    ...
    header.className = "library-table-headers";
    header.innerHTML = `
      <span class="library-table-headers-th library-table-headers-th--name">Name</span>
      <span class="library-table-headers-th library-table-headers-th--modified">Modified</span>
      <span class="library-table-headers-th library-table-headers-th--size">Size</span>
      <span class="library-table-headers-th library-table-headers-th--type">Type</span>
    `;
    return header;
  }
  ...
  function syncContentViewMode() {
    elements.content.dataset.view = state.view === "list" ? "list" : "grid";
    elements.content.querySelector(".library-table-headers")?.remove();
