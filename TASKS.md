...
and seed export; the user also installed it. Finish the observed shutdown,
duplicate-download and kit-first recovery repairs, then verify them together
on matching artifacts. Preserve both user test Homes. The public deployment
