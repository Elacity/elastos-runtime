...
| C1-delivery | Signed three-platform candidate installation | Active / installer owner | Bootstrap, canonical Mac/Linux paths and owned-process shutdown pass source review and 38 tests. Next: complete artifacts and exact head/release content binding, isolated publisher, real platform smoke assertions and initial J1 reproduction. |
